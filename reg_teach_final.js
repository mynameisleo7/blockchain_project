...
window.addEventListener('DOMContentLoaded', async () => {
  ...
  walletAddress = '0x659F8D897D6D49538B85Ada98D8B75d405D406b7';
...
document.getElementById('regButton').addEventListener('click', async () => {
    ...
    // Function to register a teacher
      ...
      // Call the registerTeacher function on the contract
      contract.methods.registerTeacher(name, age, phone, email, location, graduateSchool,subject)
          .send({ from: walletAddress })
          .then(function(receipt) {
              // Registration successful, handle the receipt if needed
              console.log(receipt);
          })
